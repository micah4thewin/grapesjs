const getDesignKitRecords = () => [
  {
    ...
    tokens: {
      ...
      color: { brand: '#4f46e5', accent: '#0891b2', text: '#111827', textMuted: '#4b5563', surfaceAlt: '#f3f4f6' },
    },
  },
  {
  ...
  },
  {
    ...
    tokens: {
      ...
      color: { brand: '#0d9488', accent: '#f59e0b', text: '#134e4a', textMuted: '#526b68', surfaceAlt: '#f0fdfa' },
    },
  },
  {
    kitId: 'studio-mono',
    ...
    tokens: {
      ...
      color: { brand: '#18181b', accent: '#65a30d', text: '#18181b', textMuted: '#52525b', surfaceAlt: '#f4f4f5' },
    },
  },
];
