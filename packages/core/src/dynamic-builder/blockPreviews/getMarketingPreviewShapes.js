...
const getMarketingPreviewShapes = () => ({
  ...
  'db-footer-simple': [
    buildPreviewShapeMarkup(6, 18, 84, 26, { opacity: 0.1, radius: 4 }),
    buildPreviewShapeMarkup(12, 26, 18, 5, { opacity: 0.36, accent: true }),
    buildPreviewShapeMarkup(46, 27, 9, 3, { opacity: 0.24 }),
    buildPreviewShapeMarkup(58, 27, 9, 3, { opacity: 0.24 }),
    buildPreviewShapeMarkup(70, 27, 9, 3, { opacity: 0.24 }),
    buildPreviewShapeMarkup(12, 37, 30, 2.5, { opacity: 0.14 }),
  ].join(''),
  'db-footer-centered': [
    buildPreviewShapeMarkup(6, 10, 84, 40, { opacity: 0.1, radius: 4 }),
    buildPreviewShapeMarkup(38, 17, 20, 5, { opacity: 0.36, accent: true }),
    buildPreviewShapeMarkup(26, 28, 9, 3, { opacity: 0.24 }),
    buildPreviewShapeMarkup(38, 28, 9, 3, { opacity: 0.24 }),
    buildPreviewShapeMarkup(50, 28, 9, 3, { opacity: 0.24 }),
    buildPreviewShapeMarkup(62, 28, 9, 3, { opacity: 0.24 }),
    buildPreviewShapeMarkup(34, 40, 28, 2.5, { opacity: 0.14 }),
  ].join(''),
  'db-footer-newsletter': [
    buildPreviewShapeMarkup(6, 10, 84, 40, { opacity: 0.1, radius: 4 }),
    buildPreviewShapeMarkup(12, 17, 16, 5, { opacity: 0.36, accent: true }),
    buildPreviewRowMarkup(27, 2, { height: 4, radius: 2, opacity: 0.2, x: 12, width: 30 }),
    buildPreviewShapeMarkup(50, 18, 34, 8, { opacity: 0.16, radius: 3 }),
    buildPreviewShapeMarkup(50, 29, 18, 7, { opacity: 0.5, accent: true, radius: 3 }),
    buildPreviewShapeMarkup(12, 40, 40, 2.5, { opacity: 0.14 }),
  ].join(''),
  'db-footer': [
    buildPreviewShapeMarkup(6, 10, 84, 40, { opacity: 0.1, radius: 4 }),
