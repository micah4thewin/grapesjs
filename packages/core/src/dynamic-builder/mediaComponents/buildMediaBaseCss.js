const buildMediaBaseCss = (mediaThemeRecord) => {
  ...
  return [
    '.db-image, :where(.db-gallery-item, .db-carousel-slide) img { max-width: 100%; height: auto; }',
    ...
    ".db-figure[data-db-show-caption='false'] .db-figure-caption { display: none; }",
    '.db-carousel-control, .db-facade-button, .db-lightbox-control {',
    '  display: inline-flex; align-items: center; justify-content: center; gap: 0.5rem;',
    '  min-width: 2.75rem; min-height: 2.75rem; border: 0; border-radius: 999px; cursor: pointer;',
    ...
    '}',
    '.db-carousel-control:focus-visible, .db-facade-button:focus-visible, .db-lightbox-control:focus-visible,',
    '.db-carousel-dot:focus-visible, .db-gallery-item img:focus-visible {',
