  ...
  return {
    ...
    properties: [
      ...
      buildChoicePropertyRecord(
        ...
        'start',
        distributionOptions,
        forGrid({ id: 'grid-justify-content' }),
      ),
      buildChoicePropertyRecord(
        'select',
        'align-content',
      ...
      buildChoicePropertyRecord(
        ...
        'Justify self',
        'auto',
        selfPlacementOptions,
        forGridChild({ id: 'grid-justify-self' }),
      ),
      buildChoicePropertyRecord(
        'select',
        'align-self',
        ...
        'auto',
        selfPlacementOptions,
        forGridChild({ id: 'grid-align-self' }),
      ),
    ],
  };
};
