...
const buildInteractiveBlocks = () => {
  ...
  return [
    buildBlockDefinition('db-accordion-faq', 'Accordion FAQ', 'Interactive', 'accordion', { type: 'db-accordion' }),
    ...
    buildBlockDefinition('db-announcement-bar', 'Announcement bar', 'Interactive', 'callout', {
