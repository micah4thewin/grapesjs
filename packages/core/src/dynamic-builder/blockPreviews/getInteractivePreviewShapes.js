...
const getInteractivePreviewShapes = () => ({
  ...
  'db-navbar-centered': [
    buildPreviewShapeMarkup(6, 12, 84, 36, { opacity: 0.12, radius: 4 }),
    buildPreviewShapeMarkup(38, 19, 20, 6, { opacity: 0.45, accent: true }),
    buildPreviewShapeMarkup(26, 33, 12, 4, { opacity: 0.28 }),
    buildPreviewShapeMarkup(42, 33, 12, 4, { opacity: 0.28 }),
    buildPreviewShapeMarkup(58, 33, 12, 4, { opacity: 0.28 }),
    buildPreviewShapeMarkup(42, 40, 12, 1.5, { opacity: 0.5, accent: true, radius: 1 }),
  ].join(''),
  'db-navbar-split': [
    buildPreviewShapeMarkup(6, 18, 84, 24, { opacity: 0.12, radius: 4 }),
    buildPreviewShapeMarkup(11, 27, 14, 6, { opacity: 0.45, accent: true }),
    buildPreviewShapeMarkup(31, 24, 34, 12, { opacity: 0.16, radius: 6 }),
    buildPreviewShapeMarkup(34, 28, 8, 4, { opacity: 0.3 }),
    buildPreviewShapeMarkup(45, 28, 8, 4, { opacity: 0.3 }),
    buildPreviewShapeMarkup(56, 28, 6, 4, { opacity: 0.3 }),
    buildPreviewShapeMarkup(72, 25, 13, 10, { opacity: 0.34, radius: 5 }),
  ].join(''),
  'db-navbar-minimal': [
    buildPreviewShapeMarkup(11, 27, 18, 6, { opacity: 0.45, accent: true }),
    buildPreviewShapeMarkup(50, 28, 10, 4, { opacity: 0.28 }),
    buildPreviewShapeMarkup(64, 28, 10, 4, { opacity: 0.28 }),
    buildPreviewShapeMarkup(78, 28, 8, 4, { opacity: 0.28 }),
  ].join(''),
  'db-breadcrumb': [
